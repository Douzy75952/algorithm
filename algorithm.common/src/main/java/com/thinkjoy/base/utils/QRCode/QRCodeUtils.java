package com.thinkjoy.base.utils.QRCode;
...
public class QRCodeUtils {
	...
	private static BufferedImage createImageNet(String content,
			String imageUrl, boolean needCompress) throws Exception {
		Hashtable<EncodeHintType, Object> hints = new Hashtable<EncodeHintType, Object>();
		hints.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.H);
		hints.put(EncodeHintType.CHARACTER_SET, CHARSET);
		hints.put(EncodeHintType.MARGIN, 1);
	...
	private static void insertImageNet(BufferedImage source, String imageUrl,
			boolean needCompress) throws Exception {
	...
	public static byte[] createQR(String content, String imgPath,
			boolean needCompress) throws Exception {
		BufferedImage image = QRCodeUtils.createImage(content, imgPath,
				needCompress);
	...
	public static byte[] createQRNet(String content, String imageUrl,
			boolean needCompress) throws Exception {
		BufferedImage image = QRCodeUtils.createImageNet(content, imageUrl,
				needCompress);
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
		ImageOutputStream ios = ImageIO.createImageOutputStream(baos);
		ImageIO.write(image, FORMAT_NAME, ios);
	...
	public static void main(String[] args) throws Exception {
		String text = "http://qihshi.com/categreou/1239829377633/product/1239cjkj8833333/detail?appId=123123213jffdfiuuiuiuiuf111000&type=12&tag=32738kkhdhdydyegg&tf=钓鱼岛是中国的";
		 QRCodeUtils.encode(text, "/Users/larry/Desktop/add.png",
		 "/Users/larry/Desktop/1213.png", true);
