...
public class HttpUtil {
	...
	public static String executeGet(String url,Cookie[] cookies) throws Exception {
	...
	public static String executePostBinaryFile(String url, byte[] postBody,
			String postName, Map<String, String> params) {
